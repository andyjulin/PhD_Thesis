...
\newcommand{\mccl}[2]{\multicolumn{#1}{c|}{#2}}
\newcommand{\mccll}[2]{\multicolumn{#1}{c||}{#2}}

\newcommand{\glossaryitem}[2]{\item \textbf{#1} - #2}
\newcommand{\glossaryvar}[3]{\item \textbf{#1} (#2) - #3}
...
\DeclareSIUnit\MHz{\M\hertz}
\DeclareSIUnit\kHz{\k\hertz}
...
\newcommand{\xsecpsipptoDDbar}{\sigma(\psipptoDDbar)}
\newcommand{\xsecpsipptononDDbar}{\sigma(\psipptononDDbar)}
\newcommand{\BFpsipptononDDbar}{\Gamma(\psipptononDDbar)}
\newcommand{\xsecDDbar}{\sigma_{\DDbar}}
\newcommand{\fancyF}{\mathcal{F}(x, W^2)}
...
\newcommand{\Mpsip}{M^{\psip}}
\newcommand{\Geepsip}{\Gamma_{ee}^{\psip}}
\newcommand{\GeepsipptoDDbar}{\Gamma_{ee}^{\psipptoDDbar}}
...
% Define decay modes
\newcommand{\psipptoDDbar}{\psipp \rightarrow \DDbar}
\newcommand{\psipptononDDbar}{\psipp \rightarrow \nonDDbar}
