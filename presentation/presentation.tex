...
Measures curvature and interactions of charged tracks to determine momenta
}

\addframe{Time-of-Flight (ToF)}{
Analyzes time delay for particles to hit two layers to determine velocity
}

\addframe{Electromagnetic Calorimeter (EMC)}{
Measures deposition of electromagnetic energy to identify neutral tracks
}
