...
\include{sections/main/05_cross_section}
\include{sections/main/06_non_DDbar}

% Conclusion
\include{sections/main/07_conclusion}

% Bibliography
\include{sections/default/references}

% Appendices
\appendix
\include{sections/appendix/A1_glossary}
\include{sections/appendix/A2_D0_signal_fits}
\include{sections/appendix/A3_Dp_signal_fits}
\include{sections/appendix/A4_scan_hadronic_count_fits}
\include{sections/appendix/A5_scan_rec_efficiencies}
\include{sections/appendix/A6_scan_signal_counts}
